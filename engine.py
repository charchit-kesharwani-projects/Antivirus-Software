...
#Global Variable
malware_hashes = list(open("C:\\Users\\asus\Desktop\\anti test demo\\Bit-Link-Python-Antivirus-DEMO-main\\virusHash.unibit","r").read().split('\n'))
virusInfo = list(open("C:\\Users\\asus\\Desktop\\anti test demo\\Bit-Link-Python-Antivirus-DEMO-main\\virusInfo.unibit","r").read().split('\n'))
